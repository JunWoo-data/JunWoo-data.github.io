---
layout: single
title: "HW3. Introduction to Machine Learning"
...
### 1.(a) Define the KNearestNeighbor class
...
### 1.(b) Check L2 distance implementation
...
### 1.(c) Use the validation set for tuning the value of 'K'
...
### 2.(a) Softmax_loss_naive function
...
### 2.(b) Define Linear Classifier class
...
### 2.(c) Train and test the classifier
